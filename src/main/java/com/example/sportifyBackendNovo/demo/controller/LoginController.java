...
public class LoginController {
    ...
    @PostMapping("/login")
    public ResponseEntity<Atleta> processLogin(@RequestBody LoginRequest loginRequest) {
    ...
    public ResponseEntity<Atleta> processRegister(@RequestBody AtletaDTO atletaDTO) {
